...
<p align="center">
  <img src="./assets/01-login.png" alt="Login" width="30%" />
  <img src="./assets/02-google.png" alt="Google Login" width="30%" />
  <img src="./assets/03-user.png" alt="User Page" width="30%" />
</p>

<p align="center">
  <img src="./assets/04-staff.png" alt="Staff Page" width="30%" />
  <img src="./assets/05-create.png" alt="Create Page" width="30%" />
</p>
...
- [⚙️ Setting Up Environment Variables](#setting-up-environment-variables)
  ...
  - [✍️ Step 6: Update .env.example in Backend](#step-6-update-envexample-in-backend)
  - [🛠️ Step 7: Configure Google OAuth in Supabase](#step-7-configure-google-oauth-in-supabase)
  - [🔄 Step 8: Complete OAuth Redirect URI Setup](#step-8-complete-oauth-redirect-uri-setup)
  - [🛠️ Step 9: Finalise Environment Variables](#step-9-finalise-environment-variables)
...
6. Click Connect (near the top), scroll down to find the transaction pooler connection string (you may HAVE to use the downwards arrow key for this)
 ...
 <img src="./assets/06-db-connection.png" alt="Create Page" width="30%" />
...
6. You can now login using the Test account access details above as:
- 👤 A Regular User
- 🔑 A Staff User 
