...
- [⚙️ Setting Up Environment Variables](#⚙️-setting-up-environment-variables)
  - [Step 1: Setup Google Cloud Console Project](#🛠-step-1-setup-google-cloud-console-project)
  - [Step 2: Configure OAuth Consent Screen](#⚙️-step-2-configure-oauth-consent-screen)
  ...
  - [Step 6: Update .env.example in Backend](#✍️-step-6-update-envexample-in-backend)
...
### ✍️ Step 6: Update .env.example in Backend
